...
| Partially grounded (0.4–0.7) | 2040 |
| Weakly grounded (0.2–0.4) | 87 |
| Ungrounded (<0.2) | 0 |
| **Mean grounding score** | **0.695** |
...
| 2 | Fudan-fMRI/CineBrain (dataset) | 2026 | 0.517 | — |
| 3 | gasparyanartur/things-eeg2 (dataset) | 2026 | 0.534 | — |
| 4 | braindecode/isruc-sleep (dataset) | 2026 | 0.528 | — |
| 5 | RoboCOIN/Galaxea_R1_Lite_change_baai_into_brain (d | 2026 | 0.527 | — |
| 6 | braindecode/bcic2020-3 (dataset) | 2026 | 0.526 | — |
| 7 | braindecode/faced (dataset) | 2026 | 0.525 | — |
...
**Frequent 2-itemsets:** 54
**Frequent 3-itemsets:** 20
...
| Pattern | Support |
|---------|---------|
| [Emerging] AND research in Computer Science | 0.290 |
| [Emerging] AND (Very Recent work) | 0.224 |
| (Very Recent work) AND research in Computer Science | 0.180 |
| [Emerging] AND research in Neuroscience | 0.166 |
| using Neuroimaging AND research in Neuroscience | 0.165 |
| [Emerging] AND using Neuroimaging | 0.165 |
| using Neuroimaging AND research in Computer Science | 0.148 |
| (Foundational work) AND research in Neuroscience | 0.146 |
| [Emerging] AND studying Clinical | 0.139 |
| [Emerging] AND (Established work) | 0.130 |

**Top Association Rules (by lift):**

| Antecedent | Consequent | Support | Confidence | Lift |
|------------|-----------|---------|------------|------|
| topic:psychology | topic:medicine | 0.056 | 0.78 | 5.59 |
| impact:highly_cited + topic:ne | temporal:foundational | 0.083 | 0.64 | 2.93 |
| impact:highly_cited + temporal | topic:neuroscience | 0.083 | 0.93 | 2.71 |
| method:neuroimaging + temporal | topic:neuroscience | 0.057 | 0.81 | 2.36 |
| impact:highly_cited + topic:bi | topic:neuroscience | 0.051 | 0.79 | 2.31 |
| temporal:foundational + topic: | topic:neuroscience | 0.051 | 0.77 | 2.24 |
| impact:highly_cited + method:n | topic:neuroscience | 0.057 | 0.73 | 2.13 |
| temporal:foundational + topic: | topic:neuroscience | 0.062 | 0.69 | 2.02 |
| temporal:foundational | topic:neuroscience | 0.146 | 0.67 | 1.94 |
| impact:highly_cited | topic:neuroscience | 0.129 | 0.65 | 1.89 |
