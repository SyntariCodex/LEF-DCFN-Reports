...
**Date:** April 10, 2026
**Run fingerprint:** `b68d155a0c7995f4`
...
| Run timestamp | `2026-04-10T02:38:42.553719` |
| Run fingerprint | `b68d155a0c7995f4` |
| Corpus fingerprint | `no-corpus` |
...
| SVW synchronicity | 1224 candidate pairs scanned, 2 convergence events, 168 convergence anchors |
...
| Stage | Duration |
|-------|----------|
| qeb_encoding | 1m 0.9s |
| concept_graph | 382 ms |
| cte_traversal | 130 ms |
| apriori | 23 ms |
| svw | 32 ms |
| hypothesis_generation | 0 ms |
| post_traversal_calibration | 143 ms |
| bridge_detection | 3 ms |
| **Total measured** | **1m 1.7s** |
...
| 5 | FAULTFINDER: A DIAGNOSTIC EXPERT SYSTEM WITH GRACEFUL DEGRAD | 1988 | 21 |
| 6 | BRB Prediction With Customized Attributes Weights and Tradeo | 2020 | 21 |
