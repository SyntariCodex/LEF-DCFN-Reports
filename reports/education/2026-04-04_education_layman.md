...
This article synthesizes 3118 sources in Education & EdTech into a cross-sectional review of the field's foundations, frontiers, gaps, and most promising research directions. Where gaps exist, this article bridges them — articulating the specific studies, projects, or prototypes that would advance the field. Every claim traces to specific sources in the analyzed corpus.

*For full methodology, parameters, and reproducibility data, see the accompanying Technical Report.*

## The Research Landscape

This analysis covers 3118 sources in Education & EdTech, mapped into 3118 research papers and 17 topic areas with 7330 connections.
...
**3108 structural gaps** identified in the research landscape:

- **950 moderate** — important but less urgent
- **2158 minor** — older or isolated issues

**Prevalence by type:** 3108 decayed; 3018 stale; 343 orphaned.
...
*2198 sources, Established (avg. year: 2018.6)*

This cluster centers on The PRISMA 2020 statement: an updated guideline for reporting systematic reviews with 2198 interconnected sources.
...
*49 sources, Established (avg. year: 2018.4)*

This cluster centers on Core principles of assessment in competency-based medical education with 49 interconnected sources.

### Human Circulating and Tissue-Resident CD56bright Natural Killer Cell Populations
*12 sources, Established (avg. year: 2019.9)*

This cluster centers on Human Circulating and Tissue-Resident CD56bright Natural Killer Cell Populations with 12 interconnected sources.
...
- "The PRISMA 2020 statement: an updated guideline for reporting systematic reviews" and "Core principles of assessment in competency-based medical education" (49% structural similarity)
- "The PRISMA 2020 statement: an updated guideline for reporting systematic reviews" and "Human Circulating and Tissue-Resident CD56bright Natural Killer Cell Populations" (82% structural similarity)
...
**20398 candidate pairs** (297 high-confidence) grouped into **12 convergence events**.

**SVW_002 — Moderate convergence** (score: 0.311)

*3 independent research groups converged on similar findings within 2 years*

Converging sources:
- Predicting learner’s performance through video sequences viewing behavior ana... [14]
- ShengcaiLiao/QAConv: [ECCV 2020] QAConv: Interpretable and Generalizable Pers... [15]
- alibaba-mmai-research/TAdaConv: [ICLR 2022] TAda! Temporally-Adaptive Convolu... [16]

**SVW_012 — Moderate convergence** (score: 0.200)

*2 independent research groups converged on similar findings within 1 year*

Converging sources:
- mahatasourav/Class_Suru: Class_Suru is an educational platform offering both ... [17]
- mdnuruzzamanKALLOL/Beecrowd_Judge: URI or Beecrowd Online Judge is widely use... [18]

**SVW_011 — Moderate convergence** (score: 0.181)

*5 independent research groups converged on similar findings within 8 years*

Converging sources:
- Corrigendum to "On injective modules and support varieties for the small quan... [19]
- Support posets of some monomial ideals [20]
- Character sheaves in characteristic $p$ have nilpotent singular support [21]
- Support theories for non-Noetherian tensor triangulated categories [22]
- *(+1 more)*

**SVW_001 — Moderate convergence** (score: 0.171)

*2023 independent research groups converged on similar findings within 61 years*

Converging sources:
- GPT-based Open-Ended Knowledge Tracing [23]
- Mutil-View Contrastive Learning for Knowledge Tracing Based on Multi-Faceted ... [24]
- Fast Causal Discovery by Approximate Kernel-based Generalized Score Functions... [25]
- Deep Knowledge Tracing Integrating Multiple Learning Behaviors [26]
- *(+2019 more)*

**SVW_009 — Moderate convergence** (score: 0.134)

*2 independent research groups converged on similar findings within 2 years*

Converging sources:
- Using Machine Learning to Evaluate Attending Feedback on Resident Performance. [27]
- A Glycemia Risk Index (GRI) of Hypoglycemia and Hyperglycemia for Continuous ... [28]
...
Based on 3118 sources in Education & EdTech:
...
This analysis covered 3118 sources in Education & EdTech. Every claim traces to specific sources. The gap-bridging synthesis — connecting established findings to propose specific studies — is this article's original contribution.
...
[11] THU-TIOE-ML/GLM3_6B_Education_Ornstein. (2026). ID: `hf_bd57d1ed9...`. Referenced in: recommended path.

[12] THU-TIOE-ML/Mixtral8_7B_Education_Ornstein. (2026). ID: `hf_4ebc144fa...`. Referenced in: recommended path.

[13] TheBloke/merlyn-education-corpus-qa-v2-GGUF. (2023). ID: `hf_2b8bad10c...`. Referenced in: recommended path.

[14] Predicting learner’s performance through video sequences viewing behavior ana.... (N/A). ID: `931dca1b96e5...`. Referenced in: convergence event.

[15] ShengcaiLiao/QAConv: [ECCV 2020] QAConv: Interpretable and Generalizable Pers.... (N/A). ID: `github:Sheng...`. Referenced in: convergence event.

[16] alibaba-mmai-research/TAdaConv: [ICLR 2022] TAda! Temporally-Adaptive Convolu.... (N/A). ID: `github:aliba...`. Referenced in: convergence event.

[17] mahatasourav/Class_Suru: Class_Suru is an educational platform offering both .... (N/A). ID: `github:mahat...`. Referenced in: convergence event.

[18] mdnuruzzamanKALLOL/Beecrowd_Judge: URI or Beecrowd Online Judge is widely use.... (N/A). ID: `github:mdnur...`. Referenced in: convergence event.

[19] Corrigendum to "On injective modules and support varieties for the small quan.... (N/A). ID: `arxiv:1606.0...`. Referenced in: convergence event.

[20] Support posets of some monomial ideals. (N/A). ID: `arxiv:2009.0...`. Referenced in: convergence event.

[21] Character sheaves in characteristic $p$ have nilpotent singular support. (N/A). ID: `arxiv:2211.1...`. Referenced in: convergence event.

[22] Support theories for non-Noetherian tensor triangulated categories. (N/A). ID: `arxiv:2312.0...`. Referenced in: convergence event.

[23] GPT-based Open-Ended Knowledge Tracing. (N/A). ID: `004d6ce718b0...`. Referenced in: convergence event.

[24] Mutil-View Contrastive Learning for Knowledge Tracing Based on Multi-Faceted .... (N/A). ID: `00738e4dd8d8...`. Referenced in: convergence event.

[25] Fast Causal Discovery by Approximate Kernel-based Generalized Score Functions.... (N/A). ID: `00ab01589b80...`. Referenced in: convergence event.

[26] Deep Knowledge Tracing Integrating Multiple Learning Behaviors. (N/A). ID: `00d8bd3aa873...`. Referenced in: convergence event.

[27] Using Machine Learning to Evaluate Attending Feedback on Resident Performance.. (N/A). ID: `pmid:3332378...`. Referenced in: convergence event.

[28] A Glycemia Risk Index (GRI) of Hypoglycemia and Hyperglycemia for Continuous .... (N/A). ID: `pmid:3534839...`. Referenced in: convergence event.
