# DCFN Technical Report: quantum physics × dream psychology × academic success

**Proof of Receipt — DCFN Engine Run**

**Engine:** DCFN v0.3.0-prototype — Living Eden Frameworks LLC
**Date:** April 08, 2026
**Run fingerprint:** `e96630dd1166a55f`
...
| Run timestamp | `2026-04-08T19:49:19.126213` |
| Run fingerprint | `e96630dd1166a55f` |
| Corpus fingerprint | `no-corpus` |
...
|-------|----------------|
| QEB encoding | 412 sources encoded |
| Concept graph | 443 nodes / 4057 edges constructed |
| CTE backward traversal | 5 chains (sum of chain depths: 6) |
| CTE forward cascade | 5 cascades (0 implications, 0 blocked paths) |
| CTE entropy detection | 407 entropy nodes inspected (266 critical, 34 high) |
...
| Apriori pattern mining | 22 1-itemsets, 36 2-itemsets, 6 3-itemsets, 17 rules |
| SVW synchronicity | 2105 candidate pairs scanned, 3 convergence events, 233 convergence anchors |
...
| Stage | Duration |
|-------|----------|
| qeb_encoding | 1m 34.9s |
| concept_graph | 594 ms |
| cte_traversal | 187 ms |
| apriori | 26 ms |
| svw | 434 ms |
| hypothesis_generation | 0 ms |
| post_traversal_calibration | 226 ms |
| bridge_detection | 3 ms |
| **Total measured** | **1m 36.4s** |
...
|--------|-----------|---------|------|
| contamination_filter | 445 | 33 | 412 |
...
| Cross-domain edges | 604 |
| Bridge nodes | 284 |

### 2.3 Entropy Nodes

**Total:** 407 (critical: 266, high: 34, low: 107)

**Surfaced gaps (classification only):**

| # | Title | Bridge confidence |
|---|-------|-------------------|
| 1 | Consciousness as an Inhibited Manifestation and Quantum Physics. | — |
| 2 | Do animals dream? | — |
| 3 | How bizarre? A pluralist approach to dream content. | — |
| 4 | Quantum simulation and computing with Rydberg-interacting qubits | — |
| 5 | Quantum physics in neuroscience and psychology: a neurophysical model of mind-br | — |
| 6 | Semantic parsing of the life process by quantum biology. | — |
| 7 | EEG microstates of dreams. | — |
| 8 | Anticipations of dream psychology in the Talmud | — |
| 9 | Academic mentees succeed in big groups, but thrive in small groups | — |
| 10 | Motivation as an Enabler for Academic Success | — |
| 11 | Does Emotional Intelligence Assist in the Prediction of Academic Success? | — |
| 12 | Meta-Analysis of the Relationship Between the Big Five and Academic Success at U | — |
| 13 | A Model for Academic Success: The School and Home Environment of East Asian Stud | — |
| 14 | Latino adolescents' academic success: The role of discrimination, academic motiv | — |
| 15 | Examining the Academic Success of Latino Students in Science Technology Engineer | — |
| 16 | Towards a better understanding of conceptual difficulties in introductory quantu | — |
| 17 | Quantum Physics Education Research over the Last Two Decades: A Bibliometric Ana | — |
| 18 | Effect of an introductory quantum physics course using experiments with heralded | — |
| 19 | The Dream of God: How Do Religion and Science See Lucid Dreaming and Other Consc | — |
| 20 | The importance of very high life satisfaction for students’ academic success | — |
...
| Cluster | Size | Status |
|---------|------|--------|
| Quantum Computation and Quantum Information | 137 | Established |
| Quantum physics in space | 9 | Established |
| Quantum Simulation for High-Energy Physics | 9 | Established |
| Building academic success on social and emotional learning: what does the resear | 147 | Established |
| Recent Advances on Graphene Quantum Dots: From Chemistry and Physics to Applicat | 2 | Established |
| New Introductory Lectures on Psycho-Analysis | 111 | Established |
...
| Convergence anchors | 233 |

**Top anchors (rank only):**

| Rank | Anchor | Year | Independent groups |
|------|--------|------|--------------------|
| 1 | Quantum Computing for High-Energy Physics: State of the Art  | 2023 | 35 |
| 2 | Quantum Chemistry in the Age of Quantum Computing. | 2019 | 34 |
| 3 | The Physics of Quantum Information | 2022 | 35 |
| 4 | Monitoring Quantum Simulators via Quantum Non-Demolition Cou | 2020 | 41 |
| 5 | Quantum Computation and Quantum Information | 2012 | 33 |
| 6 | A general quantum algorithm for open quantum dynamics demons | 2021 | 34 |
| 7 | What is quantum biology? | 2026 | 35 |
| 8 | Quantum reference frame transformations as symmetries and th | 2020 | 32 |
| 9 | Opportunities for Nuclear Physics & Quantum Information Scie | 2019 | 32 |
| 10 | Quantum machine learning: from physics to software engineeri | 2023 | 32 |
...
|------|-------|------|--------------|
| 1 | Towards a better understanding of conceptual difficulties in introduct | 2021 | Yes |
| 2 | T. Bouchée | None | — |
| 3 | Investigating teachers’ and students’ experiences of quantum physics l | 2021 | — |
| 4 | University students dataset related to achievement, classroom practice | 2023 | — |
| 5 | Investigating synchronous and asynchronous class attendance as predict | 2020 | — |
| 6 | Defining and Measuring Academic Success | 2020 | — |
| 7 | The importance of very high life satisfaction for students’ academic s | 2017 | Yes |
| 8 | Latino adolescents' academic success: The role of discrimination, acad | 2008 | Yes |
| 9 | Academic mentees succeed in big groups, but thrive in small groups | 2022 | Yes |
| 10 | Social networks, social capital, social support and academic success i | 2020 | — |
...
**H05** [MEDIUM]
- **Hypothesis:** Re-examining 'Quantum physics in neuroscience and psychology: a neurophysical mod...' with contemporary methods will produce findings that substantially update or contradict current consensus in this area
- **Grounded in:** entropy gap node: Quantum physics in neuroscience and psychology: a neuroph...
- **Novel because:** not yet connected to 'Neuroscience' despite logical dependency in prerequisite chain
- **Suggested method:** mixed-methods approach (apriori patterns unavailable)
